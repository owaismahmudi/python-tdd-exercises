...
[![Build Status](https://travis-ci.org/owaismahmudi/python-tdd-exercises.svg?branch=master)](https://travis-ci.org/owaismahmudi/python-tdd-exercises/builds)
[![Coverage Status](https://coveralls.io/repos/owaismahmudi/python-tdd-exercises/badge.png?branch=master)](https://coveralls.io/r/owaismahmudi/python-tdd-exercises?branch=master)

After you fork, edit this `README.md` and rename "owaismahmudi" to your GitHub username
...
- Increase the test coverage to 100% by making [all lines](https://coveralls.io/r/owaismahmudi/python-tdd-exercises?branch=master) green.
